...
meas_name = 'measurement_H_ref_x.mat';  % file name of the measurement data, x-axis
% meas_name = 'measurement_H_ref_y.mat';  % y-axis
% meas_name = 'measurement_H_ref_z.mat';  % z-axis
...
input_path = path;
input_name = 'input_H_ref.mat';         % file name for the input data
...
prep.numDelays = 6;             % number of delays used in the measurement
...
prep.discardData{1}(:,1,1000:end,1:10) = 0;     % We exclude the last 30 ms of the measurements
...
plotter.plot_GSTFs(H_fft,['H^r^e^f_F_F_T_,_',ax_name], H_LF,['H^r^e^f_L_F_,_',ax_name], H_HF,['H^r^e^f_H_F_,_',ax_name], H_combined,['H^r^e^f_',ax_name], 4, term2plot, ax_name);
disp('    main_H_ref.m finished.')
